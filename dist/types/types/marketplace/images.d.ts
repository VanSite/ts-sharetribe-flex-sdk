...
export type ImageVariantNames = 'default' | 'landscape-crop	crop' | 'landscape-crop2x' | 'landscape-crop4x' | 'landscape-crop6x' | 'scaled-small' | 'scaled-medium' | 'scaled-large' | 'scaled-xlarge' | 'square-small' | 'square-small2x' | 'facebook' | 'twitter';
