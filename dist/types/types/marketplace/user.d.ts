...
type DataType<E extends UsersEndpoints, P extends AllUsersParameter> = E extends 'show' ? UserType<UsersType<P>> : never;
export type UsersResponse<E extends UsersEndpoints, P extends AllUsersParameter> = {
    data: DataType<E, P>;
